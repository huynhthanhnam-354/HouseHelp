...
export default function GoogleAuthButton({ onClick }) {
  ...
  const handleClick = () => {
    if (!isGoogleLoaded || !window.google) {
      alert('Google đang tải. Vui lòng thử lại sau giây lát.');
      return;
    }
  ...
  // Mock Google login for development (when Google OAuth is not properly configured)
  const handleMockGoogleLogin = () => {
    ...
    console.log('🔧 Using mock Google login:', mockUser);
  ...
  return (
    <div>
      ...
      >
        ...
        {isGoogleLoaded ? 'Tiếp tục với Google' : 'Đang tải Google...'}
      </button>
